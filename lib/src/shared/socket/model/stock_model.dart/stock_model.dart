...
abstract class Stock with _$Stock {
  const factory Stock({
    ...
    @Default('') String symbol,
    @Default('') String exchange,
    @Default('') String exchangeshortname,
    @Default('') String source,
    @Default('') String type,
    @Default('') String companyName,
    @Default(false) bool isActivelyTrading,
    @Default(false) bool isAdr,
    @Default(false) bool isEtf,
    @Default(false) bool isFund,
    @Default('') String isin,
    @Default(0) double marketCap,
...
abstract class FiveDayTrend with _$FiveDayTrend {
  const factory FiveDayTrend({List<double>? data}) = _FiveDayTrend;
