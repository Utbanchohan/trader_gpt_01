...
class _ChatApi implements ChatApi {
  ...
  Future<BaseModel<DeleteResponse>> deleteChat(String chatId) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseModel<DeleteResponse> _value;
    try {
      _value = BaseModel<DeleteResponse>.fromJson(
        _result.data!,
        (json) => DeleteResponse.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
